...
const permissions = shield({
  ...
  Mutation: {
    ...
    signUp: isPublic,
    addQuestion: isAuthenticatedAndEmailConfirmed,
    addBlogPost: isAuthenticatedAndEmailConfirmed,
    addAnswer: isAuthenticatedAndEmailConfirmed,
    addComment: isAuthenticatedAndEmailConfirmed,
